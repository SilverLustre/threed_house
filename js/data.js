var dict = {
  ...
  insulation: {
    ...
    camera: {
      default: "front",
      front: { pos: "", components: ["insulation_f_1", "insulation_f_1"] },
  ...
  water_use: {
    ...
    camera: {
      default: "front",
      front: { pos: "", components: ["water_use_1", "water_use_1"] },
      back: { pos: "", components: [] },
      left: { pos: "", components: [] },
      right: { pos: "", components: [] },
      top: { pos: "", components: ["water_use_1", "water_use_1"] },
    },
    components: {
      water_use_1: {
        text: `Rainwater Tank:
